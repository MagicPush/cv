...
Общий стаж: 15 лет и 4 месяца<br/>
...
Менеджмент: Управление разработкой, Управление людьми, Построение команды, Onboarding, Agile, Scrum, Kanban, Jira, YouTrack<br/>
Разработка: PHP, PHPUnit, MySQL, CI/CD, Docker, Bash, Symfony, Yii2, Sphinx, Redis, ClickHouse, Linux, REST API, GitLab, YAGNI, DRY, KISS, SOLID<br/>
...
Период: _2024-11 - 2025-05, 7 месяцев_<br/>
...
5. Хорошо себя чувствую и эффективно работаю на удалёнке так же, как раньше работал в офисе.
...
3. В свободное время почитываю литературу в области менеджмента и психологии, разбираюсь в PostgreSQL и Kotlin, планирую изучать Go и Python.
